...
$title = $description = $category = $location = $genderRepresentation = $url = $startsAt = $endsAt = $award = $imageUrl = "";
$titleError = $descriptionError = $categoryError = $locationError = $genderRepresentationError = $urlError = $startsAtError = $endsAtError = $awardError = $imageUrlError = "";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($titleError == "" && $descriptionError == "" && $urlError == "" && $startsAtError == "" && $endsAtError == "" && $imageUrlError == "" && $awardError == "") {
        ...
        $sql = "INSERT INTO broadcast(title, description, category_id, location, gender_representation, url, starts_at, ends_at, award, image_url) VALUES ('{$title}', '{$description}', '{$category}', '{$location}', '{$genderRepresentation}', '{$url}', '{$startsAt}', '{$endsAt}', '{$award}', '{$imageUrl}');";
