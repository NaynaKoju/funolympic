    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users WHERE email='{$email}'")) > 0) {
        ...
        if ($query) {
            ...
            try {
                ...
                $mail->Body = '<h1 style="color:#4070f4;">Secure Auth</h1><p>Change the password for your account using the link below</p><b><a href="http://localhost/pd-nayna/change-password.php?reset=' . $code . '">http://localhost/pd-nayna/change-password.php?reset=' . $code . '</a></b>';
