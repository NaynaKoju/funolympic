    ...
    if ($data['success'] == "true") {
        ...
        if (mysqli_num_rows($result) === 1) {
            ...
            if ($account_verified == "1") {
                ...
                $mail->Body = '<h1 style="color:#4070f4;">Secure Auth</h1><p>Click the link provided below to verify your account and get access to our features.</p><b><a href="http://localhost/pd-nayna/login.php?verification=' . $code . '">http://localhost/pd-nayna/login.php?verification=' . $code . '</a></b>';
    ...
    <div class="container">
        <div class="forms">
            <div class="form login">
                <span class="title">GET LOGED IN</span>
                <?php echo $msg; ?>
                ...
                <div class="login-signup">
                    <span class="text">Dont't have an account? <a href="register.php">Register here</a>.</span>
                </div>
            </div>
        </div>
    </div>
