...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $sql = "SELECT n.id, n.title, n.description, n.image_url, n.created_at, c.id as category_id, c.name as category FROM news n inner join category c on c.id = n.category_id WHERE n.id = ?";
