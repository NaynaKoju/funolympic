        ...
        <div class="box">
            <div>
                ...
                if ($viewingSchedules) {
                    ...
                    echo '<h1>Upcoming Broadcasts</h1>';
                    echo '</div>';
                    echo '<div>';
                            ...
                            foreach ($startDates as $startDate) {
                                ...
                                if (($startDate->format('Y-m-d') === $currentDateTime->format('Y-m-d'))) {
                                    ...
                                    foreach ($broadcastList as $broadcast) {
                                        ...
                                        echo '<a href="/pd-nayna/schedule.php?broadcast=' . $broadcast['id'] . '" role="button" style="background-color: cornflowerblue;color: white;padding: 8px 12px; border-radius: 6px;display: inline-block;">View More</a>';
                                        echo "</div>";
                                    }
                                    echo "</div>";
                                    echo '</div>';
