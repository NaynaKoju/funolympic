<?php
    ...
    $id = $email = $name = $password = $c_password = $admin = $verified = "";
    $nameError = $emailError = $passwordError = $c_passwordError = $adminError = $verifiedError =  "";
                ...
                <div class="form-container">
                    <form action="edit.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="in-box">
                                <input type="checkbox" name="is_admin" <?= $admin == "1" ? "checked" : "" ?> class="form-control" >
                            </div>
                        </div>
